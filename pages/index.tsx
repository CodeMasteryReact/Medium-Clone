    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className='flex justify-between items-center bg-yellow-400 border-y border-black py-10 lg:py-0'>
        <div className='px-10 space-y-5'>
          ...
          <img className='hidden md:inline-flex h-32 lg:h-full' src="/images/medium-logo.png" alt="" />
      </div>
        ...
        {posts.map(post => (
          <Link key={post._id} href={`/post/${post.slug.current}`}>
            <div className='border rounded-lg group cursor-pointer overflow-hidden'>
              <img className='h-60 w-full object-cover group-hover:scale-105 tansition-tranform duration-200 ease-in-out' src={ urlFor(post.mainImage).url()! } alt="" />
